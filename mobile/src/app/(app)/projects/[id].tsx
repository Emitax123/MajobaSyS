...
const styles = StyleSheet.create({
  ...
  createdAt: { fontSize: Typography.size.xs, color: Colors.textDisabled },
  ...
  btnDangerText: { fontSize: Typography.size.md, fontWeight: Typography.weight.semibold, color: Colors.white },
